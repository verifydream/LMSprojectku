    ...
    public function run(): void
    {
        $categories = [
            [
                ...
                'image_url' => 'categories/Impor.svg',
                'is_active' => true,
                'order' => 1,
            ],
            [
                ...
                'image_url' => 'categories/Ekspor.svg',
                'is_active' => true,
                'order' => 2,
            ],
            [
                ...
                'image_url' => 'categories/Cukai.svg',
                'is_active' => true,
                'order' => 3,
            ],
            [
            ...
            [
                ...
                'image_url' => 'categories/Lainnya.svg',
                'is_active' => true,
                'order' => 5,
            ],
        ];
