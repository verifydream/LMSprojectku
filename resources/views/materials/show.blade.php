...
<div class="max-w-4xl mx-auto">
    ...
    <nav class="mb-6 text-sm">
        <ol class="flex items-center space-x-2 text-gray-600">
            ...
            <li>/</li>
            <li><a href="{{ route('materials.index') }}" class="hover:text-primary">Materi</a></li>
            <li>/</li>
            <li><a href="{{ route('materials.index', ['category' => $material->category->slug]) }}" class="hover:text-primary">{{ $material->category->name }}</a></li>
            <li>/</li>
            <li class="text-gray-900 font-semibold">{{ $material->title }}</li>
        </ol>
    </nav>
        ...
        <div class="p-8">
            ...
            <div class="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-gray-200">
                ...
                <div class="flex items-center text-yellow-500 text-xl">
                    ...
                    ⭐
                    @endfor
                    <span class="text-gray-700 ml-2 text-base">({{ $material->rating }}/5)</span>
                </div>
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-700 text-lg leading-relaxed">{{ $material->description }}</p>
            </div>
            ...
            <div class="mb-8">
                <h2 class="text-2xl font-bold text-gray-800 mb-4">File Download</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @if($material->file_pdf)
                    <a href="{{ asset('storage/' . $material->file_pdf) }}" 
                       target="_blank"
                       class="flex items-center p-4 bg-red-50 rounded-lg hover:bg-red-100 transition-colors border border-red-200">
                        <div class="w-12 h-12 bg-red-500 rounded-lg flex items-center justify-center text-white text-2xl mr-4">
                            📄
                        </div>
                        <div>
                            <p class="font-semibold text-gray-800">File PDF</p>
                            <p class="text-sm text-gray-600">Klik untuk download</p>
                        </div>
                    </a>
                    @endif
                    ...
                    <a href="{{ asset('storage/' . $material->file_ppt) }}" 
                       target="_blank"
                       class="flex items-center p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors border border-orange-200">
                        <div class="w-12 h-12 bg-orange-500 rounded-lg flex items-center justify-center text-white text-2xl mr-4">
                            📊
                        </div>
                        <div>
                            <p class="font-semibold text-gray-800">File PowerPoint</p>
                            <p class="text-sm text-gray-600">Klik untuk download</p>
                        </div>
                    </a>
                    @endif
                    ...
                    <a href="{{ asset('storage/' . $material->file_word) }}" 
                       ...
                       class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors border border-blue-200">
                        ...
                        <div>
                            <p class="font-semibold text-gray-800">File Word</p>
                            <p class="text-sm text-gray-600">Klik untuk download</p>
                        </div>
                    </a>
                    @endif
                    ...
                    <a href="{{ asset('storage/' . $material->file_video) }}" 
                       ...
                       class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors border border-purple-200">
                        ...
                        <div>
                            <p class="font-semibold text-gray-800">File Video</p>
                            <p class="text-sm text-gray-600">Klik untuk play</p>
                        </div>
                    </a>
                    @endif
                </div>
